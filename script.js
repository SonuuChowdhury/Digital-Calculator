...
function operatorControlInit(opr) {
  //taking actions according to the operator selected by the user
  if (opr == "+") {
...
function delValue(n) {
  //Deleting a value by string slicing
  if (n == 0) {
...
function answerControl() {
  //answer function calling by considering the  different values of operatorIndicator
